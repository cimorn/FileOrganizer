...
- Changed Windows release downloads to `FileOrganizer-V26.07.02-win-x64.zip`, which contains the full runnable app folder after extraction.
...
- If the Windows executable is running, `pnpm run build:desktop` may fail because Windows locks `dist\文件整理-v26.07.02.exe`. Close the app before rebuilding.
